...
const PWAActionSheet = class {
    constructor(hostRef) {
        ...
        this.options = [];
        this.open = false;
        this.onSelection = core.createEvent(this, "onSelection", 7);
    }
    componentDidLoad() {
    ...
    render() {
        return (core.h("div", { class: `wrapper${this.open ? ' open' : ''}`, onClick: () => this.dismiss() }, core.h("div", { class: "content" }, core.h("div", { class: "title" }, this.header), this.options.map((option, i) => core.h("div", { class: "action-sheet-option", onClick: (e) => this.handleOptionClick(e, i) }, core.h("div", { class: "action-sheet-button" }, option.title))))));
    }
