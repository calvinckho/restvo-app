...
export declare type ElementEventType = 'blur' | 'change' | 'click' | 'focus' | 'ready';
export declare type ElementType = 'card' | 'cardNumber' | 'cardExpiry' | 'cardCvc' | 'postalCode' | 'paymentRequestButton' | 'iban' | 'idealBank';
