...
export class UserData {
    ...
    versions = { // current app's version that will be used to compare with labels loaded from the database
        'Activity Components': 19, // this is the current activity components version used by this code, make this higher than the mongodb stored value to force reload the app's cache
