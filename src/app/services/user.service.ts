...
export class UserData {
    ...
    versions = { // current app's version that will be used to compare with labels loaded from the database
        'Activity Components': 21, // this is the current activity components version used by this code, make this higher than the mongodb stored value to force reload the app's cache
        'List of Components': [ 10000, 10010, 10050, 10100, 10200, 10210, 10300, 10310, 10320, 10330, 10360, 10370, 10400, 10500, 10600, 20000, 20010, 30000, 40000, 50000, 40010, 40020, 11000, 10210, 20020, 12000, 10220 ] // this is the list of components used by this code
    };
